    ...
    <main className="pdetail">
        ...
        <div className="pdetail-hero-inner">
          ...
          <figure className="pdetail-hero-cover">
            <div className="pdetail-hero-cover-tag">
              <span>Branding + App</span> <span>2024</span>
            </div>
      ...
      <section className="pdetail-facts">
        <dl className="pdetail-facts-inner">
          ...
          <div className="pdetail-fact"><dt>Services</dt><dd>Branding &middot; Mobile App &middot; UX</dd></div>
      ...
      <section className="pdetail-showcase">
        <div className="pdetail-showcase-head">
          <p className="pdetail-lede">
            Meridian was entering a crowded fintech space but targeting an audience ignored by
            incumbent players. They needed a brand that communicated trust and accessibility,
            plus a mobile app that made financial management genuinely simple.
          </p>
        </div>
      </section>
      ...
      <section className="pdetail-showcase">
        <div className="pdetail-showcase-head">
          ...
          <h2 className="pdetail-showcase-title">Standing out in a crowded market</h2>
        </div>
      ...
      <section className="pdetail-showcase">
        <div className="pdetail-showcase-head">
          ...
          <h2 className="pdetail-showcase-title">Brand warmth meets financial trust</h2>
        </div>
        <div className="pdetail-gallery">
      ...
      <section className="pdetail-showcase">
        <div className="pdetail-showcase-head">
          ...
          <h2 className="pdetail-showcase-title">94 NPS, 12k users in month one</h2>
        </div>
        <div className="pdetail-gallery">
