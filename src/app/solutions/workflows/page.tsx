      ...
      <main className="container" style={{ paddingTop: '120px', minHeight: '100vh', position: 'relative', zIndex: 1 }}>
        <header className="hero" style={{ textAlign: 'center', marginBottom: '80px' }}>
          <h1 className="title" style={{ fontSize: '4rem', marginBottom: '20px' }}>
            <span className="title-main">The Central Nervous System</span>
          </h1>
          <p className="description" style={{ fontSize: '1.4rem', color: '#aaa', maxWidth: '800px', margin: '0 auto', lineHeight: '1.6' }}>
            Connecting disparate software through advanced Make and Zapier routing to eliminate all manual data transfer.
          </p>
        </header>
        ...
        <section className="features-section" style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px', marginBottom: '100px' }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '32px', alignItems: 'stretch' }}>
            <LuminousCard 
              ...
              description="If the software has an API, we connect it. From niche industry tools to legacy ERPs, we build the bridge. AI orchestration."
              autoPulse={true}
            />
            <LuminousCard 
              title="Self-Healing Architecture" 
              description="Workflows that detect API failures and automatically retry or fallback. Intelligent error routing ensures zero dropped operations ever."
            />
            <LuminousCard 
              title="Data Synchronization" 
              description="Perfect data parity between billing systems, CRMs, and fulfillment dashboards. Always in real-time, always in sync, always accurate."
            />
          </div>
        </section>
